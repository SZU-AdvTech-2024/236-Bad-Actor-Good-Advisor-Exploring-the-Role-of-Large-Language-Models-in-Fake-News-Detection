...
parser.add_argument('--news_encoder_path', type=str, default='bert-base-uncased')
parser.add_argument('--rationale_encoder_path', type=str, default='bert-base-uncased')
...
parser.add_argument('--dataset', type=str, default='arg_origin')
